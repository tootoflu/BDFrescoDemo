...
public class Test1Activity extends Activity {
    ...
    public void applyNewUri(View view) {
        Uri uri = mSimpleDraweeView.getImageUri();
        String uriStr = uri == null ? "null" : uri.toString();
        if (uriStr.equals(mUri)) {
            return;
        }
    ...
    public void applyNewUri1(View view) {
        Uri uri = mSimpleDraweeView1.getImageUri();
        String uriStr = uri == null ? "null" : uri.toString();
        if (uriStr.equals(mUri1)) {
            return;
        }
    ...
    public void applyNewUri2(View view) {
        Uri uri = mSimpleDraweeView2.getImageUri();
        String uriStr = uri == null ? "null" : uri.toString();
        if (uriStr.equals(mUri2)) {
            return;
        }
    ...
    public void applyNewUri3(View view) {
        Uri uri = mSimpleDraweeView3.getImageUri();
        String uriStr = uri == null ? "null" : uri.toString();
        if (uriStr.equals(mUri3)) {
            return;
        }
    ...
    public void applyNewUri4(View view) {
        Uri uri = mSimpleDraweeView4.getImageUri();
        String uriStr = uri == null ? "null" : uri.toString();
        if (uriStr.equals(mUri4)) {
            return;
        }
    ...
    public void applyNewUri5(View view) {
        Uri uri = mSimpleDraweeView5.getImageUri();
        String uriStr = uri == null ? "null" : uri.toString();
        if (uriStr.equals(mUri5)) {
            return;
        }
